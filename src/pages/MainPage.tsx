...
export function MainPage() {
  return (
    <div className={"main-page-container"}>
        <Header />
        <LinkButton label={<Label text={"Перейди по ссылке!!!"} color={"#fff"}/>} url={"https://ai.nsu.ru/projects/dovcom/time_entries"}/>
        <main>
            <MainPageButtons />
            <Button className={buttonClasses.defaultButtonBlue}
          ...
          />
          <Button
              className={buttonClasses.defaultButtonBlue} label={<Label text={"Недоступно"} />} disabled={true}
          />
        </main>
    </div>
  );
